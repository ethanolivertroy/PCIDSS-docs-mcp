...
/**
 * Parse PCI-DSS requirement ID into components
 * Examples: "1" => {major: 1}, "1.2" => {major: 1, minor: 2}, "1.2.3" => {major: 1, minor: 2, sub: 3}
 */
 ...
 * Examples: "1.2.3" => "1.2", "1.2" => "1", "1" => undefined
 */
export function getParentRequirementId(id: string): string | undefined {
...
/**
 * Check if requirement A is a child of requirement B
 * Examples: isChildOf("1.2.3", "1.2") => true, isChildOf("1.2.3", "1") => true
 */
